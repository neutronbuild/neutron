...
import (
	...
	"github.com/neutronbuild/neutron/lib"
	"github.com/neutronbuild/neutron/pkg/ip"
	"github.com/neutronbuild/neutron/pkg/version"
...
func main() {
	...
	toppanel := ui.NewPar(fmt.Sprintf("Neutron Appliance %s\n\n%s\n%s", version.GetBuild().ShortVersion(), getCPUs(), getMemory()))
